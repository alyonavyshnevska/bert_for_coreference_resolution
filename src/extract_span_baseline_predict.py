    ...
    with tf.Session() as session:
        ...
        with open(input_filename) as input_file:
            ...
            for example_num, line in enumerate(input_file.readlines()):
                ...
                parent_child_emb_pos = span_util.get_parent_child_emb_baseline(pos_clusters, candidate_span_emb, candidate_starts, candidate_ends, "positive", doc_key)
                parent_child_emb_neg = span_util.get_parent_child_emb_baseline(neg_clusters, candidate_span_emb, candidate_starts, candidate_ends, "negative", doc_key)
